...
import { authGuard, guestGuard, passwordGuard, roleGuard, strictRoleGuard } from './core/guards/auth.guard';
...
export const routes: Routes = [
  ...
  { path: 'examen-virtual', component: ExamenVirtualComponent, title: 'Examen virtual - Sistema de Evaluaciones' },
  {
    ...
    children: [
      ...
      { path: 'dashboard', component: DashboardComponent, canActivate: [roleGuard(['ADMINISTRADOR_SISTEMA', 'RESPONSABLE_EVALUACIONES', 'PERSONAL_EVALUACIONES', 'DOCENTE', 'VICERRECTOR', 'DIRECTOR_CARRERA', 'VERIFICADOR'])], title: 'Dashboard - Sistema de Evaluaciones' },
