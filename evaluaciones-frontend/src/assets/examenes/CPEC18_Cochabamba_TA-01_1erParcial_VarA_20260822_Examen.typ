  ...
  [
    ...
    #table(
      ...
      [
        ...
        #text(size: 7.5pt, weight: "bold", fill: rgb("#4c1d95"))[CTL-9102-CPEC18]
      ],
    ...
    #table(
      ...
      [#text(size: 7.5pt)[*ESTUDIANTE:* JUAN CARLOS PÉREZ MAMANI]],
      [#text(size: 7.5pt)[*CÓDIGO:* 7849102]],
  ...
  [
    ...
    #rect(width: 100%, height: 100%, stroke: 0.75pt + black, fill: rgb("#fafafa"), inset: (x: 1.5pt, y: 2pt), radius: 2pt)[
      ...
      #align(center)[
        ...
        #text(size: 4.5pt, fill: luma(100))[ID: 7849102]
      ]
    ]
  ]
)
