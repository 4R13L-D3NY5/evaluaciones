...
#block(spacing: 3.5pt)[
  *1.* #raw("Pregunta de prueba numero 8", block: false)
...
#block(spacing: 3.5pt)[
  *2.* #raw("Pregunta de prueba numero 2", block: false)
  #h(10pt) *A)* #raw("Opcion C", block: false)\
...
#block(spacing: 3.5pt)[
  *3.* #raw("Pregunta de prueba numero 1", block: false)
...
#block(spacing: 3.5pt)[
  *4.* #raw("Pregunta de prueba numero 5", block: false)
...
#block(spacing: 3.5pt)[
  *6.* #raw("Pregunta de prueba numero 10", block: false)
  #h(10pt) *A)* #raw("Opcion C", block: false)\
...
#block(spacing: 3.5pt)[
  *7.* #raw("Pregunta de prueba numero 9", block: false)
  #h(10pt) *A)* #raw("Opcion A", block: false)\
  #h(10pt) *B)* #raw("Opcion E", block: false)\
  #h(10pt) *C)* #raw("Opcion C", block: false)\
...
#block(spacing: 3.5pt)[
  *8.* #raw("Pregunta de prueba numero 42", block: false)
  #h(10pt) *A)* #raw("Opcion D", block: false)\
  #h(10pt) *B)* #raw("Opcion E", block: false)\
  #h(10pt) *C)* #raw("Opcion B", block: false)\
  #h(10pt) *D)* #raw("Opcion C", block: false)\
  #h(10pt) *E)* #raw("Opcion A", block: false)\
]

#block(spacing: 3.5pt)[
  *9.* #raw("Pregunta de prueba numero 26", block: false)
  #h(10pt) *A)* #raw("Opcion D", block: false)\
  #h(10pt) *B)* #raw("Opcion A", block: false)\
  #h(10pt) *C)* #raw("Opcion C", block: false)\
  #h(10pt) *D)* #raw("Opcion B", block: false)\
...
#block(spacing: 3.5pt)[
  *10.* #raw("Pregunta de prueba numero 29", block: false)
  #h(10pt) *A)* #raw("Opcion D", block: false)\
  #h(10pt) *B)* #raw("Opcion E", block: false)\
  #h(10pt) *C)* #raw("Opcion C", block: false)\
  #h(10pt) *D)* #raw("Opcion B", block: false)\
...
#block(spacing: 3.5pt)[
  *11.* #raw("Pregunta de prueba numero 23", block: false)
  #h(10pt) *A)* #raw("Opcion B", block: false)\
  #h(10pt) *B)* #raw("Opcion A", block: false)\
  #h(10pt) *C)* #raw("Opcion C", block: false)\
  #h(10pt) *D)* #raw("Opcion D", block: false)\
...
#block(spacing: 3.5pt)[
  *12.* #raw("Pregunta de prueba numero 41", block: false)
...
#block(spacing: 3.5pt)[
  *13.* #raw("Pregunta de prueba numero 32", block: false)
  #h(10pt) *A)* #raw("Opcion D", block: false)\
  #h(10pt) *B)* #raw("Opcion B", block: false)\
  #h(10pt) *C)* #raw("Opcion C", block: false)\
  #h(10pt) *D)* #raw("Opcion E", block: false)\
...
#block(spacing: 3.5pt)[
  *14.* #raw("Pregunta de prueba numero 40", block: false)
  #h(10pt) *A)* #raw("Opcion C", block: false)\
  #h(10pt) *B)* #raw("Opcion A", block: false)\
  #h(10pt) *C)* #raw("Opcion E", block: false)\
  #h(10pt) *D)* #raw("Opcion D", block: false)\
...
#block(spacing: 3.5pt)[
  *15.* #raw("Pregunta de prueba numero 44", block: false)
  #h(10pt) *A)* #raw("Opcion D", block: false)\
  #h(10pt) *B)* #raw("Opcion C", block: false)\
  #h(10pt) *C)* #raw("Opcion E", block: false)\
  #h(10pt) *D)* #raw("Opcion A", block: false)\
...
#block(spacing: 3.5pt)[
  *16.* #raw("Pregunta de prueba numero 37", block: false)
  #h(10pt) *A)* #raw("Opcion D", block: false)\
  #h(10pt) *B)* #raw("Opcion E", block: false)\
  #h(10pt) *C)* #raw("Opcion B", block: false)\
  #h(10pt) *D)* #raw("Opcion C", block: false)\
...
#block(spacing: 3.5pt)[
  *17.* #raw("Pregunta de prueba numero 35", block: false)
  #h(10pt) *A)* #raw("Opcion D", block: false)\
  #h(10pt) *B)* #raw("Opcion A", block: false)\
  #h(10pt) *C)* #raw("Opcion E", block: false)\
  #h(10pt) *D)* #raw("Opcion B", block: false)\
...
#block(spacing: 3.5pt)[
  *19.* #raw("Pregunta de prueba numero 45", block: false)
  #h(10pt) *A)* #raw("Opcion C", block: false)\
  #h(10pt) *B)* #raw("Opcion A", block: false)\
  #h(10pt) *C)* #raw("Opcion B", block: false)\
  #h(10pt) *D)* #raw("Opcion D", block: false)\
...
#block(spacing: 3.5pt)[
  *20.* #raw("Pregunta de prueba numero 34", block: false)
  #h(10pt) *A)* #raw("Opcion E", block: false)\
  #h(10pt) *B)* #raw("Opcion D", block: false)\
  #h(10pt) *C)* #raw("Opcion A", block: false)\
  #h(10pt) *D)* #raw("Opcion B", block: false)\
...
#block(spacing: 3.5pt)[
  *21.* #raw("Pregunta de prueba numero 43", block: false)
  #h(10pt) *A)* #raw("Opcion A", block: false)\
  #h(10pt) *B)* #raw("Opcion B", block: false)\
  #h(10pt) *C)* #raw("Opcion E", block: false)\
  #h(10pt) *D)* #raw("Opcion D", block: false)\
...
#block(spacing: 3.5pt)[
  *22.* #raw("Pregunta de prueba numero 18", block: false)
  #h(10pt) *A)* #raw("Opcion C", block: false)\
  #h(10pt) *B)* #raw("Opcion B", block: false)\
  #h(10pt) *C)* #raw("Opcion E", block: false)\
  #h(10pt) *D)* #raw("Opcion D", block: false)\
...
#block(spacing: 3.5pt)[
  *23.* #raw("Pregunta de prueba numero 38", block: false)
  #h(10pt) *A)* #raw("Opcion E", block: false)\
  #h(10pt) *B)* #raw("Opcion C", block: false)\
  #h(10pt) *C)* #raw("Opcion A", block: false)\
  #h(10pt) *D)* #raw("Opcion B", block: false)\
...
#block(spacing: 3.5pt)[
  *24.* #raw("Pregunta de prueba numero 59", block: false)
  #h(10pt) *A)* #raw("Opcion B", block: false)\
  #h(10pt) *B)* #raw("Opcion C", block: false)\
  #h(10pt) *C)* #raw("Opcion D", block: false)\
  #h(10pt) *D)* #raw("Opcion E", block: false)\
...
#block(spacing: 3.5pt)[
  *25.* #raw("Pregunta de prueba numero 50", block: false)
  #h(10pt) *A)* #raw("Opcion C", block: false)\
  #h(10pt) *B)* #raw("Opcion A", block: false)\
  #h(10pt) *C)* #raw("Opcion E", block: false)\
  #h(10pt) *D)* #raw("Opcion D", block: false)\
...
#block(spacing: 3.5pt)[
  *26.* #raw("Pregunta de prueba numero 58", block: false)
  #h(10pt) *A)* #raw("Opcion B", block: false)\
  #h(10pt) *B)* #raw("Opcion E", block: false)\
  #h(10pt) *C)* #raw("Opcion C", block: false)\
  #h(10pt) *D)* #raw("Opcion D", block: false)\
...
#block(spacing: 3.5pt)[
  *27.* #raw("Pregunta de prueba numero 49", block: false)
  #h(10pt) *A)* #raw("Opcion E", block: false)\
  #h(10pt) *B)* #raw("Opcion C", block: false)\
  #h(10pt) *C)* #raw("Opcion D", block: false)\
  #h(10pt) *D)* #raw("Opcion A", block: false)\
...
#block(spacing: 3.5pt)[
  *28.* #raw("Pregunta de prueba numero 51", block: false)
  #h(10pt) *A)* #raw("Opcion E", block: false)\
  #h(10pt) *B)* #raw("Opcion D", block: false)\
  #h(10pt) *C)* #raw("Opcion C", block: false)\
  #h(10pt) *D)* #raw("Opcion A", block: false)\
...
#block(spacing: 3.5pt)[
  *29.* #raw("Pregunta de prueba numero 60", block: false)
  #h(10pt) *A)* #raw("Opcion C", block: false)\
  #h(10pt) *B)* #raw("Opcion B", block: false)\
  #h(10pt) *C)* #raw("Opcion D", block: false)\
  #h(10pt) *D)* #raw("Opcion A", block: false)\
...
#block(spacing: 3.5pt)[
  *30.* #raw("Pregunta de prueba numero 46", block: false)
  #h(10pt) *A)* #raw("Opcion B", block: false)\
  #h(10pt) *B)* #raw("Opcion E", block: false)\
  #h(10pt) *C)* #raw("Opcion A", block: false)\
  #h(10pt) *D)* #raw("Opcion C", block: false)\
