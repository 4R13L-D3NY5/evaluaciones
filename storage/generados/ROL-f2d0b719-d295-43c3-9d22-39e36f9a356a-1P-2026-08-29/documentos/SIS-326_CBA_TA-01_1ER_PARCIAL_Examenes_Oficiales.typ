...
#table(
  ...
  [MATERIA: #raw("LENGUAJES DE PROGRAMACIÓN DE ÚLTIMA GENERACIÓN", block: false)], [GRUPO: #raw("TA-01", block: false)    SEMESTRE: #raw("6", block: false)],
  [DOCENTE: #raw("DOCENTE SEA (CI 9520276)", block: false)], [EXAMEN: #raw("1ER PARCIAL", block: false)],
  [FECHA: #raw("29/08/2026", block: false)], [HORA: #raw("12:45 - 14:15", block: false)],
