  ...
  header: context {
    ...
    if p > 1 {
      grid(
        columns: (1fr, auto),
        align: (left, right),
        [#text(fill: luma(90))[ESTUDIANTE PLACEHOLDER B · #text(weight: "bold")[PLA-B]]],
...
#table(
  ...
  [
    *CODIGO:* \
    #v(-2pt)
    #align(center)[#text(weight: "bold")[PLA-B]]
  ]
)
...
#block(breakable: false, spacing: 1.5em)[
  *4.* #raw("___", block: false) #raw("Pregunta Fácil 9: ¿Cuál es la función principal de la capa de enlace de datos en el modelo OSI?", block: false)\
...
#block(breakable: false, spacing: 1.5em)[
  *5.* #raw("___", block: false) #raw("Pregunta Difícil 14: En una modulación 256-QAM con ancho de banda de 20 MHz y factor roll-off 0.25, la tasa binaria neta alcanzable es:", block: false)\
...
#block(breakable: false, spacing: 1.5em)[
  *9.* #raw("___", block: false) #raw("Pregunta Fácil 8: La fibra óptica monomodo presenta menor atenuación que la multimodo a largas distancias.", block: false)\
...
#block(breakable: false, spacing: 1.5em)[
  *12.* #raw("___", block: false) #raw("Pregunta Media 14: I. El retardo de propagación depende de la distancia.
...
#block(breakable: false, spacing: 1.5em)[
  *14.* #raw("___", block: false) #raw("Pregunta Media 26: I. El retardo de propagación depende de la distancia.
II. El retardo de transmisión depende de la tasa de bits.", block: false)\
...
#block(breakable: false, spacing: 1.5em)[
  *15.* #raw("___", block: false) #raw("Pregunta Media 22: I. El retardo de propagación depende de la distancia.
II. El retardo de transmisión depende de la tasa de bits.", block: false)\
  #h(1em) *A)* #raw("C. Si ambas son verdaderas", block: false)\
  #h(1em) *B)* #raw("D. Si ninguna es verdadera", block: false)\
...
#block(breakable: false, spacing: 1.5em)[
  *16.* #raw("___", block: false) #raw("Pregunta Media 20: I. El retardo de propagación depende de la distancia.
II. El retardo de transmisión depende de la tasa de bits.", block: false)\
  #h(1em) *A)* #raw("D. Si ninguna es verdadera", block: false)\
  #h(1em) *B)* #raw("B. Si la segunda es verdadera", block: false)\
  #h(1em) *C)* #raw("C. Si ambas son verdaderas", block: false)\
...
#block(breakable: false, spacing: 1.5em)[
  *17.* #raw("___", block: false) #raw("Pregunta Media 30: I. El retardo de propagación depende de la distancia.
II. El retardo de transmisión depende de la tasa de bits.", block: false)\
...
#block(breakable: false, spacing: 1.5em)[
  *18.* #raw("___", block: false) #raw("Pregunta Media 28: I. El retardo de propagación depende de la distancia.
II. El retardo de transmisión depende de la tasa de bits.", block: false)\
  #h(1em) *A)* #raw("A. Si la primera es verdadera", block: false)\
  #h(1em) *B)* #raw("B. Si la segunda es verdadera", block: false)\
  #h(1em) *C)* #raw("D. Si ninguna es verdadera", block: false)\
...
#block(breakable: false, spacing: 1.5em)[
  *19.* #raw("___", block: false) #raw("Pregunta Media 27: Características de la modulación OFDM: 1. Alta eficiencia espectral, 2. Resistencia al desvanecimiento, 3. Baja ISI, 4. Nula PAPR.", block: false)\
...
#block(breakable: false, spacing: 1.5em)[
  *20.* #raw("___", block: false) #raw("Pregunta Media 11: Características de la modulación OFDM: 1. Alta eficiencia espectral, 2. Resistencia al desvanecimiento, 3. Baja ISI, 4. Nula PAPR.", block: false)\
...
#block(breakable: false, spacing: 1.5em)[
  *21.* #raw("___", block: false) #raw("Pregunta Media 17: Características de la modulación OFDM: 1. Alta eficiencia espectral, 2. Resistencia al desvanecimiento, 3. Baja ISI, 4. Nula PAPR.", block: false)\
...
#block(breakable: false, spacing: 1.5em)[
  *22.* #raw("___", block: false) #raw("Pregunta Media 25: Características de la modulación OFDM: 1. Alta eficiencia espectral, 2. Resistencia al desvanecimiento, 3. Baja ISI, 4. Nula PAPR.", block: false)\
  #h(1em) *A)* #raw("2 y 4 son correctas", block: false)\
  #h(1em) *B)* #raw("1 y 3 son correctas", block: false)\
  #h(1em) *C)* #raw("Todas son correctas", block: false)\
  #h(1em) *D)* #raw("Solo 4 es correcta", block: false)\
...
#block(breakable: false, spacing: 1.5em)[
  *23.* #raw("___", block: false) #raw("Pregunta Media 29: Características de la modulación OFDM: 1. Alta eficiencia espectral, 2. Resistencia al desvanecimiento, 3. Baja ISI, 4. Nula PAPR.", block: false)\
  #h(1em) *A)* #raw("Todas son correctas", block: false)\
...
#block(breakable: false, spacing: 1.5em)[
  *26.* #raw("___", block: false) #raw("Pregunta Media 3: Características de la modulación OFDM: 1. Alta eficiencia espectral, 2. Resistencia al desvanecimiento, 3. Baja ISI, 4. Nula PAPR.", block: false)\
  #h(1em) *A)* #raw("1 y 3 son correctas", block: false)\
...
#block(breakable: false, spacing: 1.5em)[
  *27.* #raw("___", block: false) #raw("Pregunta Media 23: Características de la modulación OFDM: 1. Alta eficiencia espectral, 2. Resistencia al desvanecimiento, 3. Baja ISI, 4. Nula PAPR.", block: false)\
  #h(1em) *A)* #raw("Todas son correctas", block: false)\
  #h(1em) *B)* #raw("2 y 4 son correctas", block: false)\
  #h(1em) *C)* #raw("Solo 4 es correcta", block: false)\
...
#block(breakable: false, spacing: 1.5em)[
  *28.* #raw("___", block: false) #raw("Problema Difícil 5: Calcule la pérdida en el espacio libre (FSPL) para un enlace a 5 GHz a 10 km: ", block: false) + $  "FSPL" = 20 log(d) + 20 log(f) + 92.45  $\
  ...
  #h(1em) *B)* #raw("98.5 dB", block: false)\
...
#block(breakable: false, spacing: 1.5em)[
  *30.* #raw("___", block: false) #raw("Problema Difícil 1: Calcule la pérdida en el espacio libre (FSPL) para un enlace a 5 GHz a 10 km: ", block: false) + $  "FSPL" = 20 log(d) + 20 log(f) + 92.45  $\
