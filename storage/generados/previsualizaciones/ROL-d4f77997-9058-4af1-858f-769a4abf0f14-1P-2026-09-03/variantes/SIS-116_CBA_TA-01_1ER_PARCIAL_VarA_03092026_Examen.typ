...
#table(
  ...
  [MATERIA: #raw("INTRODUCCIÓN A LAS CIENCIAS DE LA COMPUTACIÓN", block: false)], [GRUPO: #raw("TA-01", block: false)    SEMESTRE: #raw("1", block: false)],
  [DOCENTE: #raw("WALTER JOSE CAZAS CASTRO", block: false)], [EXAMEN: #raw("1ER PARCIAL", block: false)],
  [FECHA: #raw("03/09/2026", block: false)], [HORA: #raw("09:45", block: false)],
