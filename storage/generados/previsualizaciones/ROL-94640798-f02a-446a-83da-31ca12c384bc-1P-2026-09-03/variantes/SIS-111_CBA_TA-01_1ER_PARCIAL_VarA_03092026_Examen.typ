...
#table(
  ...
  [MATERIA: #raw("CALCULO I", block: false)], [GRUPO: #raw("TA-01", block: false)    SEMESTRE: #raw("1", block: false)],
  [DOCENTE: #raw("JIMENA GIOVANNA ARNEZ MARTINEZ", block: false)], [EXAMEN: #raw("1ER PARCIAL", block: false)],
