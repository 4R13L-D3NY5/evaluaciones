...
#set page(
  ...
  footer: context {
    grid(
      ...
      align: (left, right),
      [
        #raw("ESPINOZA ALVAREZ MAYKOL JOSUE", block: false)\
        #text(size: 15pt, weight: "bold")[1107301]
      ],
...
#table(
  ...
  stroke: 0.4pt + black,
  inset: 4pt,
  [NOMBRE: #raw("ESPINOZA ALVAREZ MAYKOL JOSUE", block: false)], [CARRERA: #raw("LICENCIATURA EN INGENIERÍA DE SISTEMAS", block: false)],
  [MATERIA: #raw("TELECOMUNICACIONES", block: false)], [GRUPO: #raw("TA-01", block: false)    SEMESTRE: #raw("7", block: false)],
  [DOCENTE: #raw("DOCENTE SEA (CI 6522053)", block: false)], [EXAMEN: #raw("1ER PARCIAL", block: false)],
  [FECHA: #raw("30/08/2026", block: false)], [HORA: #raw("12:45 - 14:15", block: false)],
  [FIRMA DEL ESTUDIANTE: #h(1em)........................................],
  [CODIGO: #text(size: 15pt)[#raw("1107301", block: false)]],
)
#v(0.8em)
