...
#table(
  ...
  [MATERIA: #raw("FÍSICA II", block: false)], [GRUPO: #raw("TA-01", block: false)    SEMESTRE: #raw("2", block: false)],
  [DOCENTE: #raw("JOSE DAVID QUIÑONES COCA", block: false)], [EXAMEN: #raw("1ER PARCIAL", block: false)],
...
#block(width: 100%)[#align(center)[#image("imagen_reactivo_2_6b437e1014fe.png", width: 45%)]]\
  #v(0.15em)
  #block(inset: (left: 1em))[
...
#block(breakable: false, spacing: 1.2em)[
  ...
  #block(inset: (left: 1em))[
    ...
    #text(weight: "regular")[3) #raw("El logaritmo de un producto de dos números es igual a la suma de los logaritmos de cada uno de esos números por separado.", block: false)]\\
