  ...
  header: context {
    ...
    if p > 1 {
      grid(
        columns: (1fr, auto),
        align: (left, right),
        [#text(size: 8pt, fill: luma(90))[SERGIO ALEJANDRO MENDOZA TAPIA · #text(font: "Courier", weight: "bold")[7391028]]],
...
#table(
  ...
  [
    *CODIGO:* \
    #v(-2pt)
    #align(center)[#text(size: 18pt, weight: "bold")[7391028]]
  ]
)
...
#block(spacing: 3.5pt)[
  *8.* El débito fiscal IVA se genera en la venta de bienes muebles en el momento de la entrega del bien o emisión de factura, lo que ocurra primero.
  #h(10pt) *A)* Verdadero\
  #h(10pt) *B)* Falso\
]
...
#block(spacing: 3.5pt)[
  *11.* Las multas pagadas por contravenciones tributarias al SIN son consideradas gastos deducibles en la liquidación del IUE.
  #h(10pt) *A)* Verdadero\
  #h(10pt) *B)* Falso\
]
...
#block(spacing: 3.5pt)[
  *13.* I. Las notas fiscales emitidas por el Sistema Electrónico no requieren impresión física para su validez.\
...
#block(spacing: 3.5pt)[
  *14.* I. El crédito fiscal IVA respaldado por compras vinculadas a la actividad gravada es computable.\
...
#block(spacing: 3.5pt)[
  *24.* En una constructora con contrato de Bs 2.000.000 y 60% de avance físico certificado, ¿cuál es el ingreso gravado devengado en el IUE?
...
#block(spacing: 3.5pt)[
  *25.* Calcule el reparo impositivo aplicable por IUE no deducible al detectarse facturas sin bancarización por Bs 150.000:
...
#block(spacing: 3.5pt)[
  *26.* Efecto de la provisión por garantías de post-construcción en la liquidación del IUE:
...
#block(spacing: 3.5pt)[
  *27.* Calcule el interés moratorio generado si transcurrieron 500 días con una tasa de interés del 4% anual sobre el tributo omitido:
