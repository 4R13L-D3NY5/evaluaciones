...
// ============================================================================
// EXAMEN OFICIAL UNITEPC - SERGIO ALEJANDRO MENDOZA TAPIA (ID: 7391028)
...
#grid(
  ...
  [
    ...
    #table(
      columns: (65%, 35%),
      stroke: 0.5pt + black,
      [#text(size: 9pt)[*NOMBRE:* SERGIO ALEJANDRO MENDOZA TAPIA]],
      [#text(size: 9pt)[*CODIGO:* 7391028]],
  ...
  [
    ...
    #rect(width: 100%, stroke: 0.85pt + black, fill: rgb("#fafafa"), inset: (x: 1.5pt, y: 4pt), radius: 2pt)[
      ...
      #align(center)[
        ...
        #text(size: 5.5pt, fill: luma(100))[ID: 7391028]
      ]
    ]
  ]
)
