...
// ============================================================================
// EXAMEN OFICIAL UNITEPC - PAOLA ANDREA MORALES VARGAS (ID: 8102938)
...
#grid(
  ...
  [
    ...
    #table(
      columns: (65%, 35%),
      stroke: 0.5pt + black,
      [#text(size: 9pt)[*NOMBRE:* PAOLA ANDREA MORALES VARGAS]],
      [#text(size: 9pt)[*CODIGO:* 8102938]],
  ...
  [
    ...
    #rect(width: 100%, stroke: 0.85pt + black, fill: rgb("#fafafa"), inset: (x: 1.5pt, y: 4pt), radius: 2pt)[
      ...
      #align(center)[
        ...
        #text(size: 5.5pt, fill: luma(100))[ID: 8102938]
      ]
    ]
  ]
)
