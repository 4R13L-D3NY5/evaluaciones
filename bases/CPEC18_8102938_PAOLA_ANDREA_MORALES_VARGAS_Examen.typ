  ...
  header: context {
    ...
    if p > 1 {
      grid(
        columns: (1fr, auto),
        align: (left, right),
        [#text(size: 8pt, fill: luma(90))[PAOLA ANDREA MORALES VARGAS · #text(font: "Courier", weight: "bold")[8102938]]],
...
#table(
  ...
  fill: none,
  inset: (x: 5pt, y: 2.2pt),
  [*NOMBRE:* PAOLA ANDREA MORALES VARGAS],
  ...
  [
    *CODIGO:* \
    #v(-2pt)
    #align(center)[#text(size: 18pt, weight: "bold")[8102938]]
  ]
)
...
#block(spacing: 3.5pt)[
  *4.* En el Régimen Complementario al IVA (RC-IVA) para dependientes, el Formulario 110 admite facturas de hasta:
...
#block(spacing: 3.5pt)[
  *8.* Las multas pagadas por contravenciones tributarias al SIN son consideradas gastos deducibles en la liquidación del IUE.
  #h(10pt) *A)* Verdadero\
  #h(10pt) *B)* Falso\
]
...
#block(spacing: 3.5pt)[
  *14.* I. Los gastos de representación con respaldo de factura son 100% deducibles en el IUE sin ningún tope reglamentario.\
...
#block(spacing: 3.5pt)[
  *15.* I. La alícuota del ICE es idéntica para bebidas alcohólicas y vehículos automotores.\
...
#block(spacing: 3.5pt)[
  *22.* Requisitos para la deducibilidad de intereses por deudas financieras contraídas en el exterior:\
...
#block(spacing: 3.5pt)[
  *28.* Cálculo del Impuesto a las Transacciones (IT) generado sobre la planilla certificada de Bs 1.200.000:
