  ...
  footer: locate(loc => {
    ...
    align(center)[
      #text(size: 7.5pt, fill: luma(80))[
        EXAMEN OFICIAL UNITEPC · COD: 7391028 · SERGIO ALEJANDRO MENDOZA TAPIA · Página #page_num de #total_pages
      ]
    ]
  })
)
  ...
  #grid(
    ...
    [
      #table(
        ...
        [#circle(radius: 3.4pt, stroke: 0.4pt + black, fill: none)[#align(center + horizon)[#text(size: 5.0pt, weight: "bold", fill: black)[C]]]],
        [#circle(radius: 3.4pt, stroke: 0.4pt + black, fill: none)[#align(center + horizon)[#text(size: 5.0pt, weight: "bold", fill: black)[D]]]],
        [#circle(radius: 3.4pt, stroke: 0.4pt + black, fill: black)[#align(center + horizon)[#text(size: 5.0pt, weight: "bold", fill: white)[E]]]]
      )
    ],
    [
      #table(
