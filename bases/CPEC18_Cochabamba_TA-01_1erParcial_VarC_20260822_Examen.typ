  ...
  [
    ...
    #table(
      ...
      [
        ...
        #text(size: 8.5pt, weight: "bold", fill: rgb("#4c1d95"))[CTL-8103-CPEC18]
      ]
    )
    ...
    #table(
      ...
      [#text(size: 9pt)[*ESTUDIANTE:* RODRIGO ALEJANDRO CONDORI RODRÍGUEZ]],
      [#text(size: 9pt)[*CÓDIGO:* 6928103]],
  ...
  [
    ...
    #rect(width: 100%, stroke: 0.75pt + black, fill: rgb("#fafafa"), inset: (x: 1.5pt, y: 3pt), radius: 2pt)[
      ...
      #align(center)[
        ...
        #text(size: 5pt, fill: luma(100))[ID: 6928103]
      ]
    ]
  ]
)
