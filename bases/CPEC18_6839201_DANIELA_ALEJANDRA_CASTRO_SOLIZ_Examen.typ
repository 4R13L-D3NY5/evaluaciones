  ...
  header: context {
    ...
    if p > 1 {
      grid(
        columns: (1fr, auto),
        align: (left, right),
        [#text(size: 8pt, fill: luma(90))[DANIELA ALEJANDRA CASTRO SOLIZ · #text(font: "Courier", weight: "bold")[6839201]]],
...
#table(
  ...
  fill: none,
  inset: (x: 5pt, y: 2.2pt),
  [*NOMBRE:* DANIELA ALEJANDRA CASTRO SOLIZ],
  ...
  [
    *CODIGO:* \
    #v(-2pt)
    #align(center)[#text(size: 18pt, weight: "bold")[6839201]]
  ]
)
...
#block(spacing: 3.5pt)[
  *14.* I. Los profesionales independientes liquidan el IUE mediante el Formulario 510 aplicando la alícuota del 25% sobre el 50% presunto.\
...
#block(spacing: 3.5pt)[
  *15.* I. Las exportaciones definitivas de bienes están gravadas con tasa cero en el IVA.\
...
#block(spacing: 3.5pt)[
  *17.* Constituyen hechos generadores del Impuesto a las Transacciones (IT):\
...
#block(spacing: 3.5pt)[
  *18.* Requisitos para la deducibilidad de intereses por deudas financieras contraídas en el exterior:\
...
#block(spacing: 3.5pt)[
  *20.* Son documentos soporte indispensables en el legajo de auditoría tributaria permanente:\
...
#block(spacing: 3.5pt)[
  *21.* En una auditoría fiscal determine los reparos aplicables por incumplimiento a la normativa tributaria:\
...
#block(spacing: 3.5pt)[
  *22.* Son condiciones formales para la deducción de sueldos y salarios en la liquidación del IUE:\
...
#block(spacing: 3.5pt)[
  *23.* Constituyen causales de nulidad absoluta en los actos administrativos tributarios:\
...
#block(spacing: 3.5pt)[
  *26.* Determine la sanción por omisión de pago si la empresa no rectifica voluntariamente antes de la Vista de Cargo:
